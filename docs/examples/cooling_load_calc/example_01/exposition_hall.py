...
class ExpositionHall:
    ...
    def _create_T_setpoint_schedule(
        ...
        Between 18 h and 8 h, the space air temperature setpoint is set to the
        value of `T_economy`. During the other hours of the day, the setpoint is
        set to the value of `T_comfort`.
        """
    ...
    def _create_internal_heat_gains(
        ...
        Between 18 h and 8 h the number of people in the space is equal to the
        value of `people_min`. During the other hours of the day, the number of
        people is equal to the value of `people_max`.
        """
