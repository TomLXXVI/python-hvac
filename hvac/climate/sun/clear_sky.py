...
class ClearSkyModel:
    ...
    def __init__(self, location: Location, tau_beam: float, tau_dif: float):
        ...
        Values of `tau_beam` and `tau_dif` are location-specific parameters
        capturing prevalent clear-sky conditions on a monthly basis. Tables for
        numerous locations worldwide have been generated by Thevenard (2009).
        """
    ...
    def get_daily_profile(self, date: Date) -> Dict[str, List[Any]]:
        """Returns the daily hourly profile of solar irradiance components on
        the horizontal surface at the given date.
