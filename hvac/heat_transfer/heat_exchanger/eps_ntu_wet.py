...
class AbstractHeatExchanger(ABC):
    ...
    def __init__(
        ...
        **kwargs
        ...
        T_r_out:
            Outlet temperature of refrigerant; may be an initial guess.
        P_r:
        ...
        self._T_r_out_ini = T_r_out.to('K')
        self.air_in = air_in
        self._P_r = P_r.to('Pa')
        ...
        if self._T_r_out_ini == self.T_r_in:
            ...
            # known.
            self._T_r_out = self._T_r_out_ini
        else:
            self._T_r_out: Quantity | None = None
    ...
    def _find_T_r_out(self) -> Quantity:
        T_r_out = self._T_r_out_ini
        i_max = 10
        i = 0
    ...
    @property
    def T_r_out(self) -> Quantity:
        return self._T_r_out or self._find_T_r_out()
