...
if TYPE_CHECKING:
    from hvac.cooling_load_calc_old.building.building_entity import BuildingEntity
    from hvac.cooling_load_calc_old.building.fixed_temperature_zone import FixedTemperatureZone
