...
class AirLayer(ConstructionLayer):
    """Represents an air space between two building material layers in a
    construction assembly.

    The thermal capacity of the air space is ignored (C = 0).
    ...
    def _determine_ha(
        ...
        """Calculates the convection coefficient of the air space."""
        t = geometry.t.to('m').m
        dT = dT.to('K').m
        ha = 0.0
        if dT <= 5:
    ...
    def _determine_hr(
        ...
        """Calculates the radiative coefficient of the air space."""
